...
import {
  ...
  ItemCanceled as ItemItemCanceled,
  ItemListed as ItemItemListed
...
export function handleItemCanceled(event: ItemItemCanceled): void {
...
export function handleItemListed(event: ItemItemListed): void {
